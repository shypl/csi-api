...
fun StringBuilder.log(arg: String, value: ZonedDateTime) = logPrefix(arg).log(value)
...
fun StringBuilder.logS(value: ZonedDateTime): StringBuilder = log(value).append(SEP)
...
fun StringBuilder.logS(arg: String, value: ZonedDateTime): StringBuilder = logPrefix(arg).log(value).append(SEP)

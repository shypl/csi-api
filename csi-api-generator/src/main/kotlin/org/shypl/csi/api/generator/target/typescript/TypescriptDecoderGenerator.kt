...
class TypescriptDecoderGenerator(
	...
	private val dependencyDecoder = libPackage.getName("tool.biser/Decoder")
	private val dependencyUnknownIdDecoderException = CodeDependency(libPackage.getName("tool.biser/_exceptions"), "UnknownIdDecoderException")
